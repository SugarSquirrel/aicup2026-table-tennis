...
out(f"v10 (GRU blend α={GRU_BLEND}) CV-B: action F1={fa_b:.4f} w={WA} β={BA:.3f}  | CV-A={fa_a:.4f}")
...
out(f"v10 multi-seed: training {len(SEEDS)} v7-GRUs + {len(SEEDS)} v8-GRUs (seeds={SEEDS})...")
ts0=time.time()
