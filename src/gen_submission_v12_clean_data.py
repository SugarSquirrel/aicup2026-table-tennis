...
out(f"v12 (noise-filter+blend α={GRU_BLEND}) CV-B: action F1={fa_b:.4f} w={WA} β={BA:.3f}  | CV-A={fa_a:.4f}")
...
Ca,Na,La_,gyA,gyP,gyR=build_seq(tr,"all",tld,exclude_uids=EXCLUDE_UIDS); Cte,Nte,Lte=build_seq(te,"sampled",tld,test_mode=True)
